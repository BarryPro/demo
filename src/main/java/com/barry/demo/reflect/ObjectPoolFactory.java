package com.barry.demo.reflect;
...
public class ObjectPoolFactory{
    ...
    public static void main(String[] args)throws Exception{
        ...
        URL str = ObjectPoolFactory.class.getClassLoader().getResource("obj.txt");
        pf.initPool(str.getPath());//本目录下的文件
        DeepClone deepClone = (DeepClone)pf.getObject("a");
        deepClone.fun();
    }
}
